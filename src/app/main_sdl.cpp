...
void printUsage(const char* programName) {
    ...
    std::cout << "                     Available states: room, town, night, night100, night1guard, castle100, castle, demon, demon100, field, battle\n";
    ...
    for (int i = 1; i < argc; i++) {
        if (strcmp(argv[i], "-h") == 0 || strcmp(argv[i], "--help") == 0) {
            ...
            if (i + 1 < argc) {
                ...
                std::cerr << "Error: --debug requires a state name (room, town, night, night100, night1guard, castle100, castle, demon, demon100, field, battle)\n";
                return 1;
            }
        } else {
