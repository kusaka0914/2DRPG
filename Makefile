...
SOURCES = src/main_sdl.cpp src/Character.cpp src/Player.cpp src/Enemy.cpp src/Battle.cpp \
          ...
          src/CastleState.cpp src/RoomState.cpp src/NightState.cpp src/DemonCastleState.cpp src/GameOverState.cpp src/EndingState.cpp src/SDL2Game.cpp \
          src/Item.cpp src/Inventory.cpp src/Equipment.cpp src/MapTerrain.cpp src/CommonUI.cpp src/TownLayout.cpp
...
HEADERS = src/Character.h src/Player.h src/Enemy.h src/Battle.h src/Graphics.h src/InputManager.h \
          src/GameState.h src/UI.h src/MainMenuState.h src/FieldState.h src/BattleState.h src/TownState.h src/CastleState.h src/RoomState.h src/GameOverState.h src/EndingState.h src/SDL2Game.h \
          src/Item.h src/Inventory.h src/Equipment.h src/MapTerrain.h src/CommonUI.h src/TownLayout.h
